    ...
    if request.method == 'POST':
        ...
        if form.is_valid():  # バリデーションを実行
            ...
            new_data = pd.DataFrame({
                ...
                '賃貸アパート': np.bool_('賃貸アパート' == initial_data['']),
                '賃貸テラス・タウンハウス': np.bool_('賃貸テラス・タウンハウス' == initial_data['']),
                '賃貸マンション': np.bool_('賃貸マンション' == initial_data['']),
                '賃貸一戸建て': np.bool_('賃貸一戸建て' == initial_data['']),
            })
