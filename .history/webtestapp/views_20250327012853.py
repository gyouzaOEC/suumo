...
def index(request):
    ...
    'S': np.int64(cleaned_data['sldk']),
    'L': np.int64(cleaned_data['sldk']),
    'D': np.int64(cleaned_data['sldk']),
    'K': np.int64(cleaned_data['sldk']),
    '賃貸アパート': np.bool_(cleaned_data['type']),
    '賃貸テラス・タウンハウス': np.bool_(cleaned_data['type']),
    '賃貸マンション': np.bool_(cleaned_data['type']),
    '賃貸一戸建て': np.bool_(cleaned_data['type']),
})
